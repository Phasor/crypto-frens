...
router.get('/user/:id', passport.authenticate('jwt', {session: false}), postController.get_post_by_user_id);
...
router.post('/:id/unlike', passport.authenticate('jwt', {session: false}), postController.post_unlike);
