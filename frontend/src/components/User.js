    ...
    <div className='flex-grow h-screen pt-6 pb-6'>
        <div className='mt-10 mx-auto max-w-md md:max-w-lg lg:max-w-2xl bg-white rounded-md shadow border p-4'>
            <div className='flex space-x-3'>
                <img src={user.profileImage} alt='profile' className='h-10 w-10 object-cover rounded-full' />
                <p className='font-medium text-lg capitalize'>{user.firstName} {user.lastName}</p>
            </div>
